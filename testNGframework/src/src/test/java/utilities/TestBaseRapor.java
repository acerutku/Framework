...
// testNG de raporlama olmadigi icin aventstack reposu kullanilir,
public abstract class TestBaseRapor {
    ...
    public void setUpTest() {
        ...
        String filePath = System.getProperty("user.dir") + "/test-output/Rapor"+date+".html"; //date ekledigimiz icin rapolar birbiri uzerine yazmayacak
